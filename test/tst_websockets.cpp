...
void WebSocketsTest::testTextMessage()
{
    ...
    QSignalSpy spy(m_pWebSocket, SIGNAL(textFrameReceived(QString,bool)));
...
{
    QSignalSpy spy(m_pWebSocket, SIGNAL(binaryFrameReceived(QByteArray,bool)));
...
#if 0
void WebSocketsTest::autobahnTest()
{
